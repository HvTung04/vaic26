...
- **LLM:** Claude API với structured output cho labeling (tagging vùng kiến thức + độ khó) và sinh lời giải thích / learning path.
...
Chốt xong taxonomy ở giờ 1 thì gửi review trước khi cả hệ thống xây trên nó.
